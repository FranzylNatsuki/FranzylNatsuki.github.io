...
const contentData = {
    3: {
        title: "Entry #3: PADAGAT: Panglimpyo sa Dagat (hosted by the DOST sa SU) [Committee Head]",
    ...
    4: {
        ...
        content1: "The bata ng calabnugan donation drive was led by CCS Students under the Dumaguete Asian Printers corporation. It was a quick donation drive and was able to raise significant funds that were handed over to the Bata ng Calabnugan Non-profit Organization.",
        content2: "I did my research on this organization and turns out they do some amazing work. In 2005, Italian national Francesco Izzo, his Filipino wife Flora Aguit, and a number of volunteers established the Bata ng Calabnugan, Inc. NGO with the goal of giving orphaned and vulnerable girls in Sibulan, Dumaguete City, and the surrounding areas in Region VII on the Island of Negros, the Philippines, a safe and nurturing environment.",
        content3: "This donation drive helped them a lot because they take care of the orphaned and would even help them to finish school. One post in their page even congratulated some of their orphaned children who the organization was able to foster. They went on to graduate with BS in Social Work and would come back and help the people who allowed her to graduate. This was inspiring because this children were able to have a good life due to the efforts of those who started and manage this organization.",
        content4: "Because of this activity, we got to help an inspiring and life-saving mission. We also got to learn of their story which was as inspiring as the things that they do now.",
...
function enlargeBox(box, contentNum) {
    ...
    // Prevent box from collapsing when clicking inside
